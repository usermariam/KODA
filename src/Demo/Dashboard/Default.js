            ...
            <Aux>
                <Row>
                    <div className="text-center">
                        <h2 className="f-w-300 d-flex align-items-center m-b-0"><i className="feather icon-arrow-up text-c-green f-30 m-r-5"/> KODA GRH</h2>
                    </div>
                </Row>
                ...
                <Row>
                    <Col md={6} xl={4}>
                        <Card>
                            <Card.Body>
                                <h6 className='mb-4'>Nombre d'employés</h6>
                    ...
                    <Col md={6} xl={4}>
                        <Card className='card-event'>
                            <Card.Body>
                                <div className="row align-items-center justify-content-center">
                                    <div className="col">
                                        <h5 className="m-0">Evènements du mois</h5>
                                    </div>
                                    <div className="col-auto">
                                        <label className="label theme-bg2 text-white f-14 f-w-400 float-right">1</label>
                                    </div>
                                </div>
                                <h2 className="mt-2 f-w-300"><sub className="text-muted f-14">50 ans de l'entreprise</sub></h2>
                            ...
                            <Card.Body className='border-bottom'>
                                <div className="row d-flex align-items-center">
                                    ...
                                    <div className="col">
                                        ...
                                        <span className="d-block text-uppercase"></span>
                                    </div>
                                </div>
                            </Card.Body>
                            <Card.Body>
                                <div className="row d-flex align-items-center">
                                    <div className="col">
                                        ...
                                        <span className="d-block text-uppercase">formations en cours</span>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
